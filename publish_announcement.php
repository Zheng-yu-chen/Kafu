...
require_once 'db.php'; // 引入資料庫連線設定

if ($_SERVER["REQUEST_METHOD"] == "POST") {//抓取資料庫的announcement表
    $title = $_POST['title']; 
...
<head>
    ...
    <div class="announcement-header">
        <!-- <i>~</i>這裡會接到<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"> -->
