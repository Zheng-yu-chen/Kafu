...
// 🎯 處理「標示為已處理」的 POST 區塊
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['usreport_id'])) {
...
<div class="mobile-wrapper">
    ...
    <div class="single-title-container">
        🚫待處理檢舉 (<?php echo count($comment_complaints); ?>)
    </div>
            ...
            ?>
                <div class="comp-card">
                    ...
                    <form method="POST" id="form-resolve-comment-<?php echo $c['usreport_id']; ?>">
                        ...
                        <button type="button" class="btn-resolve" onclick="openConfirmModal(<?php echo $c['usreport_id']; ?>)">
                            ✓ 標示為已處理
                        </button>
                    </form>
                </div>
...
<script>
    ...
    function openConfirmModal(usreportId) {
